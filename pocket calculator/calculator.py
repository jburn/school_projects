...
def addminus():
    if states["hiddenline"] == " " and states["hiddenline"] != "-":
        ...
        calcline.set(states["hiddenline"])
        states["numbers"][0] += "-"
    elif states["moves"] != 1 and states["hiddenline"] != " " and states["finished"] < 1 and states["hiddenline"] != " -":
        states["finished"] -= 1
        states["moves"] = 1
        states["hiddenline"] += "-"
...
def adddivide():
    if states["moves"] != 1 and states["finished"] < 1:
        states["finished"] -= 1
        states["moves"] = 1
        states["hiddenline"] += "/" 
...
def errordisable():
    ...
    bplus.configure(state=DISABLED)
